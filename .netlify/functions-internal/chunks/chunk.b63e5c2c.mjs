...
const $$metadata = createMetadata("/@fs/C:/work-projects/pireactor/main-site/public/assets/content/tr/services/architecture.md", { modules: [{ module: $$module1, specifier: "@astrojs/markdown-remark", assert: {} }], hydratedComponents: [], clientOnlyComponents: [], hydrationDirectives: /* @__PURE__ */ new Set([]), hoisted: [] });
const $$Astro = createAstro("/@fs/C:/work-projects/pireactor/main-site/public/assets/content/tr/services/architecture.md", "http://localhost:3000/", "file:///C:/work-projects/pireactor/main-site/");
